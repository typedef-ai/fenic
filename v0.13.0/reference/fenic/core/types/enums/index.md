...
Canonical HTML: https://docs.fenic.ai/latest/reference/fenic/core/types/enums/
...
```
              flowchart TD
              fenic.core.types.enums.CacheBackend[CacheBackend]

              click fenic.core.types.enums.CacheBackend href "" "fenic.core.types.enums.CacheBackend"
```
...
- **`LOCAL`**
  ...
  Local persistent cache backend.
