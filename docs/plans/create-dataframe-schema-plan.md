...
portability_level: 3
source_inputs:
  - docs/plans/create-dataframe-schema-structure.md
...
- [ ] `just sync-cloud`
- [ ] `uv run pytest tests/_backends/cloud/test_cloud_execution.py -k "explicit_schema or simple_count" -q`
...
> `docs/plans/create-dataframe-schema-plan.md` (track: engineering, size: high-risk).
