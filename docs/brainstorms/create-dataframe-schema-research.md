...
source_inputs:
  - docs/brainstorms/create-dataframe-schema-research.md (Research Questions section)
...
> `docs/brainstorms/create-dataframe-schema-research.md` (track: engineering, size: high-risk).
...
**Next artifact:** `docs/designs/create-dataframe-schema-design.md`
