...
from fenic.core._utils.structured_outputs import convert_pydantic_model_to_key_descriptions, convert_resolved_response_format_to_key_descriptions
...
def test_resolved_response_format_eq():
    ...
    resolved_format_boolean =  ResolvedResponseFormat.from_pydantic_model_with_descriptions(PydanticModelWithDescriptions)
    resolved_format_boolean_2 =  ResolvedResponseFormat.from_pydantic_model_with_descriptions(PydanticModelWithDescriptions)
    ...
    resolved_field_descriptions = convert_resolved_response_format_to_key_descriptions(resolved_format_boolean)
