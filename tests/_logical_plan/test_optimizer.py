...
def test_semantic_predicate_rewrite_with_other_semantic_exprs(local_session):
    ...
    golden_repr = dedent(
        """
        Filter(predicate=(semantic.extract_5fe0d417(blurb1)[lit(blurb)] = lit(blurb)))
...
def test_semantic_predicate_rewrite_complex_with_other_semantic_exprs(local_session):
    ...
    golden_repr = dedent(
        """
        Filter(predicate=((semantic.extract_5fe0d417(blurb1)[lit(blurb)] = semantic.extract_5fe0d417(blurb2)[lit(blurb)]) OR semantic.predicate_76673fa8(blurb2)))
