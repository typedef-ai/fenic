...
def cloud_session_config(cloud_app_name):
    ...
    return SessionConfig(
        ...
        semantic=SemanticConfig(
            language_models={"nano" : OpenAILanguageModelConfig(model_name="gpt-4.1-nano", rpm=500, tpm=200_000)},
            embedding_models={"oai-small": OpenAILanguageModelConfig(model_name="text-embedding-3-small", rpm=3000, tpm=1_000_000)}
        ),
        cloud=CloudConfig(
