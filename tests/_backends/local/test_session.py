...
def test_multiple_sessions(local_session_config):
    ...
    session_config3 = SessionConfig(
        ...
        semantic=SemanticConfig(
            language_models={"mini": OpenAILanguageModelConfig(model_name="gpt-4.1-mini", rpm=500, tpm=200_000)},
...
def test_combining_dataframes_from_different_sessions_raises():
    config1 = SessionConfig(
        ...
        semantic=SemanticConfig(
            language_models={
                "test_model": OpenAILanguageModelConfig(model_name="gpt-4.1-mini", rpm=500, tpm=200_000),
            },
        ),
    )
