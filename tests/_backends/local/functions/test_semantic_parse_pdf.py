...
def setup_session_with_vlm(test_model_class: BaseModel, model_name: str):
...
def test_semantic_parse_pdf_basic_markdown(request, temp_dir_just_one_file, test_model_class, test_model_name):
    ...
    local_session = setup_session_with_vlm(test_model_class=test_model_class, model_name=test_model_name)
...
@pytest.mark.parametrize("test_model_class, test_model_name", vlms_to_test)
def test_semantic_parse_pdf_markdown_with_simple_page_break_and_images(request, temp_dir_just_one_file, test_model_class, test_model_name):
