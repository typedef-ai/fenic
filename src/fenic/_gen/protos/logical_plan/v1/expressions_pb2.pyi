...
class SemanticJudgeExpr(_message.Message):
    __slots__ = ("state", "questions_json", "model_alias", "request_timeout")
...
class LogicalExpr(_message.Message):
    ...
    SEMANTIC_JUDGE_FIELD_NUMBER: _ClassVar[int]
    ...
    semantic_judge: SemanticJudgeExpr
