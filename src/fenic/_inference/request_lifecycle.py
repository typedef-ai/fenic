...
class RequestLifecycleEvent:
    ...
    Streaming-stage records set ``stage`` and ``duration_ns``; provider lifecycle
...
class StageTimingMetrics:
    """Aggregate timings for one bounded-streaming execution stage."""
...
def compute_streaming_stage_metrics(
    ...
    """Summarize duration records emitted by the bounded streaming iterator."""
