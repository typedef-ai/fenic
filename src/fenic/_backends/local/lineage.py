...
class LocalLineage(BaseLineage):
    ...
    def forwards(self, row_ids: List[str]) -> pl.DataFrame:
        ...
        parent_backwards_df = self.session_state.db_client.intermediate.read_df(
        ...
        parent_df = self.session_state.db_client.intermediate.read_df(
    ...
    def _backwards(self, ids: List[str], child_link: ChildEdge) -> pl.DataFrame:
        ...
        backwards_df = self.session_state.db_client.intermediate.read_df(
        ...
        child_df = self.session_state.db_client.intermediate.read_df(
    ...
    def get_result_df(self) -> pl.DataFrame:
        ...
        return self.session_state.db_client.intermediate.read_df(
            self.curr_operator.materialize_table
        )
