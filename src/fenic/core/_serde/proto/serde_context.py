...
class SerdeContext:
    ...
    def serialize_enum_value(self, field_name: str, enum_value: Enum, target_proto: EnumTypeWrapper):
    ...
    def deserialize_enum_value(self, field_name: str, target_type: Type[Enum], proto_enum_type: EnumTypeWrapper, serialized_value: int):
