...
def serialize_logical_plan(
    ...
    if logical_plan.cache_info is not None:
        ...
        if logical_plan.cache_info.cache_key is not None:
            cache_info_proto.duckdb_table_name = logical_plan.cache_info.cache_key
...
def deserialize_logical_plan(
    ...
    if logical_plan_proto.HasField("cache_info"):
        cache_info = CacheInfo(
            cache_key=logical_plan_proto.cache_info.duckdb_table_name if logical_plan_proto.cache_info.HasField("duckdb_table_name") else None
        )
