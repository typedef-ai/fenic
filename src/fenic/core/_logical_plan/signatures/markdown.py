...
def register_markdown_signatures():
    ...
    FunctionRegistry.register("markdown.to_json", FunctionSignature(
    ...
    FunctionRegistry.register("markdown.get_code_blocks", FunctionSignature(
    ...
    FunctionRegistry.register("markdown.generate_toc", FunctionSignature(
    ...
    FunctionRegistry.register("markdown.extract_header_chunks", FunctionSignature(
