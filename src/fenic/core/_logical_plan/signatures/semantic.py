...
def register_semantic_signatures():
    ...
    FunctionRegistry.register("semantic.map", SemanticMapExpr, FunctionSignature(
    ...
    FunctionRegistry.register("semantic.extract", SemanticExtractExpr, FunctionSignature(
    ...
    FunctionRegistry.register("semantic.predicate", SemanticPredExpr, FunctionSignature(
    ...
    FunctionRegistry.register("semantic.reduce", SemanticReduceExpr, FunctionSignature(
    ...
    FunctionRegistry.register("semantic.classify", SemanticClassifyExpr, FunctionSignature(
    ...
    FunctionRegistry.register("semantic.analyze_sentiment", AnalyzeSentimentExpr, FunctionSignature(
    ...
    FunctionRegistry.register("semantic.embed", EmbeddingsExpr, FunctionSignature(
    ...
    FunctionRegistry.register("semantic.summarize", SemanticSummarizeExpr, FunctionSignature(
