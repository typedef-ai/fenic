...
def register_json_signatures():
    ...
    FunctionRegistry.register("json.jq", FunctionSignature(
    ...
    FunctionRegistry.register("json.type", FunctionSignature(
    ...
    FunctionRegistry.register("json.contains", FunctionSignature(
